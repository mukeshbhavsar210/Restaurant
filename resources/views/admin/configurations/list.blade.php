            ...
            <div class="col-12">
                <div class="clearfix">                
                    <ul class="nav nav-tabs my-2" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link py-2" data-bs-toggle="tab" href="#tabs-3" role="tab" aria-selected="false" tabindex="-1">Pages</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link py-2" data-bs-toggle="tab" href="#tabs-4" role="tab" aria-selected="false" tabindex="-1">Permissions</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link py-2" data-bs-toggle="tab" href="#tabs-5" role="tab" aria-selected="false" tabindex="-1">Roles</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link py-2" data-bs-toggle="tab" href="#tabs-6" role="tab" aria-selected="false" tabindex="-1">Users</a>
                        </li>
                    </ul>
                </div>
                                            ...
                                            <button class="accordion-button p-xl-2 {{ $key != 0 ? 'collapsed' : '' }}"
                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-1">
                                                                <div class="flex">
                                                                    <a href="{{ route('pages.edit', $value->id ) }}" class="btn btn-outline-primary">Edit</a>
                                                                    {{-- <a href="{{ route('delete.page', $value->id) }}" class="delete-icon mt-1"><span class="sprites"></span></a> --}}
